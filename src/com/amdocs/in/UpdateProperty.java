		...
		try {
			...
			while (true) {
				...
				case 1:
					...
					sc.nextLine();
					preparedStat = conn.prepareStatement(updateQuery);
					preparedStat.setFloat(1, newPrice);
					preparedStat.setInt(2, propertyIdToUpdate);
					rowsAffected = preparedStat.executeUpdate();
				...
				case 2:
					...
					preparedStat = conn.prepareStatement(updateQuery);
					preparedStat.setString(1, newOwnerName);
					preparedStat.setInt(2, propertyIdToUpdate);
					rowsAffected = preparedStat.executeUpdate();
					System.out.println(rowsAffected + " row(s) updated.");
					break;
				case 3:
					...
					preparedStat = conn.prepareStatement(updateQuery);
					preparedStat.setString(1, newBuyerName);
					preparedStat.setInt(2, propertyIdToUpdate);
					rowsAffected = preparedStat.executeUpdate();
					System.out.println(rowsAffected + " row(s) updated.");
					break;
				case 4:
					...
					preparedStat = conn.prepareStatement(updateQuery);
					preparedStat.setFloat(1, newPrice);
					preparedStat.setString(2, newOwnerName);
					preparedStat.setString(3, newBuyerName);
					preparedStat.setInt(4, propertyIdToUpdate);
					rowsAffected = preparedStat.executeUpdate();
					System.out.println(rowsAffected + " row(s) updated.");
					break;
